            ...
            <div class="col-lg-8 col-md-10">
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" method="post" action="register.php" accept-charset="UTF-8">
                        ...
                        <div class="input-group">
                            <input type="date" class="form-control" name="txtDOB" placeholder="DATE OF BIRTH" required="required">
                            <span class="input-group-addon"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        </div>
                        <div class="input-group">
                            <input type="number" class="form-control" name="txtCID" placeholder="Citizen ID" required="required">
                            <span class="input-group-addon"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                        </div>
                        <div class="input-group">
